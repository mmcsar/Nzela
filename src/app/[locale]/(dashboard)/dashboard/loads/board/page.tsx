...
import {
  ...
  Phone, MessageSquare, Bookmark, BookmarkCheck,
...
const LoadBoardMap = dynamic(() => import('@/components/loads/LoadBoardMap'), {
  ssr: false,
  loading: () => <LoadBoardSkeleton variant="map" />,
});
  ...
  if (authLoading) {
    return (
      <div className="min-h-[400px] py-2">
        <LoadBoardSkeleton variant="page" label={t('loadingBoard')} />
      </div>
    );
  }
...
{ label: t('total'), value: stats.total, icon: Package, color: 'text-gray-700', bg: 'from-gray-50 to-gray-100/50', border: 'border-gray-200' },
                      ...
                      >
                        ...
                        <td className="px-3 py-2.5">
                          <LoadRouteVisual
                            ...
                            originAbbr={load.origin_province ? getProvAbbr(load.origin_province) : undefined}
                            destAbbr={load.destination_province ? getProvAbbr(load.destination_province) : undefined}
                          />
                        </td>
                ...
                return (
                  ...
                  >
                    ...
                    <LoadRouteVisual
                      ...
                      className="mb-3"
                      originCity={load.origin_city}
                      originProvince={load.origin_province}
                      destinationCity={load.destination_city}
                      destinationProvince={load.destination_province}
                    />
      ...
      {viewMode === 'map' && (
        isLoading && loads.length === 0 ? (
          <LoadBoardSkeleton variant="map" label={t('loadingMap')} />
        ) : (
          <LoadBoardMap
